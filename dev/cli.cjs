...
const {stdout: stdoutColor, stderr: stderrColor} = __webpack_require__(17);
const {
	stringReplaceAll,
...
const spawn = __webpack_require__(15).spawn;
...
const { spawn } = __webpack_require__(15);
...
const cssKeywords = __webpack_require__(30);
...
const fs = __webpack_require__(1);
const nodePath = __webpack_require__(0);
...
const fs = __webpack_require__(1);
const sysPath = __webpack_require__(0);
const { promisify } = __webpack_require__(5);
const readdirp = __webpack_require__(36);
const anymatch = __webpack_require__(40).default;
const globParent = __webpack_require__(41);
const isGlob = __webpack_require__(21);
const braces = __webpack_require__(43);
const normalizePath = __webpack_require__(20);

const NodeFsHandler = __webpack_require__(50);
const FsEventsHandler = __webpack_require__(54);
const {
  EV_ALL,
  EV_READY,
  EV_ADD,
...
/* harmony import */ var commander__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
...
/* harmony import */ var tree_node_cli__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(25);
/* harmony import */ var tree_node_cli__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(tree_node_cli__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var chalk__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2);
...
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1);
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(fs__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var await_shell__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(14);
/* harmony import */ var await_shell__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(await_shell__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var chokidar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(26);
/* harmony import */ var chokidar__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(chokidar__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var filetouch__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3);
/* harmony import */ var filetouch__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(filetouch__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var ora__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(55);
/* harmony import */ var ora__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(ora__WEBPACK_IMPORTED_MODULE_8__);
 ...
 * @return {void}
 */
const blue = (...msgs) => chalk__WEBPACK_IMPORTED_MODULE_3___default.a.blueBright(...msgs);

const success = (...msgs) => console.log(
    chalk__WEBPACK_IMPORTED_MODULE_3___default.a.bgCyan(
        chalk__WEBPACK_IMPORTED_MODULE_3___default.a.whiteBright(' SUCCESS '),
    ),
    ...msgs,
    '\n',
);
...
const error = (...msgs) => console.log(
    chalk__WEBPACK_IMPORTED_MODULE_3___default.a.bgRed(' ERROR '),
    ...msgs,
    '\n',
);
...
const create = async (name) => {
  if (Object(fs__WEBPACK_IMPORTED_MODULE_4__["existsSync"])(name)) {
...
const compile = async (devOnly = false) => {
  ...
  await await_shell__WEBPACK_IMPORTED_MODULE_5___default()(
...
const develop = async (program) => {
  ...
  chokidar__WEBPACK_IMPORTED_MODULE_6___default.a.watch(
      `{lib,exports}/**/*.js`,
      {
        ignoreInitial: true,
      },
...
const initialize = async (dir = '.') => {
  const libDir = Object(path__WEBPACK_IMPORTED_MODULE_0__["resolve"])(dir, 'lib');
  const compileDir = Object(path__WEBPACK_IMPORTED_MODULE_0__["resolve"])(dir, 'dist');

  /**
   * Ensure all necessary dirs exist using `filetouch`.
   */
  filetouch__WEBPACK_IMPORTED_MODULE_7___default.a.dir(dir);
  filetouch__WEBPACK_IMPORTED_MODULE_7___default.a.dir(libDir);
  filetouch__WEBPACK_IMPORTED_MODULE_7___default.a.dir(compileDir);

  /**
   * Add `lib/index.js` if it doesn't exist.
   */
  filetouch__WEBPACK_IMPORTED_MODULE_7___default.a.file(
      Object(path__WEBPACK_IMPORTED_MODULE_0__["resolve"])(libDir, 'index.js'),
      INTRO_TEMPLATE,
  );
   ...
   */
  filetouch__WEBPACK_IMPORTED_MODULE_7___default.a.file(
      Object(path__WEBPACK_IMPORTED_MODULE_0__["resolve"])(dir, '.gitignore'),
      'node_modules\/\ndist\/',
      'utf-8',
  );

  filetouch__WEBPACK_IMPORTED_MODULE_7___default.a.file(Object(path__WEBPACK_IMPORTED_MODULE_0__["resolve"])(dir, '.gnv'));
  filetouch__WEBPACK_IMPORTED_MODULE_7___default.a.file(Object(path__WEBPACK_IMPORTED_MODULE_0__["resolve"])(dir, '.eslintrc.yaml'), ESLINT_TEMPLATE);
  ...
  await await_shell__WEBPACK_IMPORTED_MODULE_5___default()(...cmds);
};


const checkInsideProject = () => fs__WEBPACK_IMPORTED_MODULE_4___default.a.existsSync(
    path__WEBPACK_IMPORTED_MODULE_0___default.a.resolve(process.cwd(), '.gnv'),
);
...
const PROJECT_NAME = Object(path__WEBPACK_IMPORTED_MODULE_0__["basename"])(CWD);
...
const TREE = (
  checkInsideProject()
  ? '\n' + tree_node_cli__WEBPACK_IMPORTED_MODULE_2___default()('./lib')
  : ''
);
...
console.log('\n', chalk__WEBPACK_IMPORTED_MODULE_3___default.a.grey('--- 𝓰𝓷𝓿 ---'), '\n');
if (HEAD) console.log(chalk__WEBPACK_IMPORTED_MODULE_3___default.a.bgBlue(chalk__WEBPACK_IMPORTED_MODULE_3___default.a.whiteBright(HEAD)));
if (TREE) console.log(chalk__WEBPACK_IMPORTED_MODULE_3___default.a.blueBright(TREE), '\n');
 ...
 */
try {
  commander__WEBPACK_IMPORTED_MODULE_1___default.a.exitOverride();
...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __webpack_require__(29);
	}
...
const fs = __webpack_require__(1);
const { Readable } = __webpack_require__(18);
const sysPath = __webpack_require__(0);
const { promisify } = __webpack_require__(5);
...
var isGlob = __webpack_require__(21);
var pathPosixDirname = __webpack_require__(0).posix.dirname;
var isWin32 = __webpack_require__(9).platform() === 'win32';
...
const stringify = __webpack_require__(11);
const compile = __webpack_require__(44);
...
const fill = __webpack_require__(22);
const utils = __webpack_require__(12);
...
const sysPath = __webpack_require__(0);
const { promisify } = __webpack_require__(5);
const isBinaryPath = __webpack_require__(51);
const {
  isWindows,
  isLinux,
  EMPTY_FN,
...
const path = __webpack_require__(0);
const binaryExtensions = __webpack_require__(52);
...
const readline = __webpack_require__(56);
const chalk = __webpack_require__(57);
const cliCursor = __webpack_require__(64);
const cliSpinners = __webpack_require__(71);
const logSymbols = __webpack_require__(73);
const stripAnsi = __webpack_require__(83);
const wcwidth = __webpack_require__(85);
const isInteractive = __webpack_require__(89);
const MuteStream = __webpack_require__(90);
...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __webpack_require__(59);
	}
...
const restoreCursor = __webpack_require__(65);
...
const onetime = __webpack_require__(66);
const signalExit = __webpack_require__(68);
...
const mimicFn = __webpack_require__(67);
...
const spinners = Object.assign({}, __webpack_require__(72));
...
const stdoutColor = __webpack_require__(80).stdout;
...
var conversions = __webpack_require__(24);
...
const ansiRegex = __webpack_require__(84);
...
var combining = __webpack_require__(88)
