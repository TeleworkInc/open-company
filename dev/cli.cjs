...
const spawn = __webpack_require__(3).spawn;
...
/* harmony import */ var commander__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
 ...
 */
try {
  commander__WEBPACK_IMPORTED_MODULE_0___default.a.exitOverride();
